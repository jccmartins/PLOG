...
data(id13, 
     ...
     [1,5,1,1,3,2,3,1,3,0,3,2,5,2,2],
     [2,4,5,1,2,4,3,1,2,1,2,2,1,4,0],
     [5-1,4-2,3-3,2-4,1-4]).


/* ships data for boards with size 6x6,7x7,10x10,12x12 and 15x15 */
shipsData(6,6,[3-1,2-2,1-3]).
shipsData(7,7,[4-1,3-1,2-2,1-3]).
shipsData(8,8,[4-1,3-2,2-3,1-3]).
shipsData(10,10,[5-1,4-1,3-2,2-3,1-4]).
shipsData(15,15,[5-1,4-2,3-3,2-4,1-4]).
